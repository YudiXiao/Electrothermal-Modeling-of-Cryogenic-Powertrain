...
% SiC MOSFET power module- CHB011M12GM4T 
% 0.29mJ-Eon and 0.13mJ-Eoff at 400V/100A
Ron_SiCMOS = 11e-3; % Drain source on-resistance, ohm
Vbd_SiCMOS = 5.8; % 3rd quadrant voltage drop, V
Eon_SiCMOS = 0.29e-3 * 400 / 400 * 50 / 100;  % Turn-on switching energy per pulse at 400V/50A, J
Eoff_SiCMOS = 0.13e-3 * 400 / 400 * 50 / 100;  % Turn-off switching energy per pulse at 400V/50A, J
...
%for count_mission = 1:1:150
    ...
    while 1
        ...
        Ploss_dcac_outSW = 3 * 2 * (IStop_three_rms ^ 2 * TempDriftronSiCMOS(T_H2_arr(2,Count_T_H2)) * Ron_SiCMOS + ...
            Idtopbd_three_avg * TempDriftdiode(T_H2_arr(2,Count_T_H2)) * Vbd_SiCMOS + ...
            fsw / 2 * TempDriftEonSiCNormMOS(T_H2_arr(2,Count_T_H2)) * Eon_SiCMOS + ...
            fsw / 2 * TempDriftEoffSiCNormMOS(T_H2_arr(2,Count_T_H2)) * Eoff_SiCMOS);
        Ploss_dcac_inSW = 3 * 2 * (ISsec_three_rms ^ 2 * TempDriftronSiCMOS(T_H2_arr(2,Count_T_H2)) * Ron_SiCMOS + ...
            Idsecbd_three_avg * TempDriftdiode(T_H2_arr(2,Count_T_H2)) * Vbd_SiCMOS + ...
            fsw / 2 * TempDriftEonSiCNormMOS(T_H2_arr(2,Count_T_H2)) * Eon_SiCMOS + ...
            fsw / 2 * TempDriftEoffSiCNormMOS(T_H2_arr(2,Count_T_H2)) * Eoff_SiCMOS);
        Ploss_dcac_clpD = 3 * 2 * Idclp_three_avg * TempDriftdiode(T_H2_arr(2,Count_T_H2)) * Vbd_SiCMOS;
