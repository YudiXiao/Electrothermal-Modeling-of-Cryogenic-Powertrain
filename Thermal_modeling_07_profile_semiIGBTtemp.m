...
% Si IGBT power module - CM100TX-34T, 12mJ-Eon and 17mJ-Eoff at 1kV/50A
Vce_IGBT = 1.4; % collector emmitor saturation voltage, V
Vec_IGBT = 2; % 3rd quadrant voltage drop, V
Eon_IGBT = 12e-3 * 400 / 1000;  % Turn-on switching energy per pulse at 400V/50A, J
Eoff_IGBT = 17e-3 * 400 / 1000;  % Turn-off switching energy per pulse at 400V/50A, J
...
%for count_mission = 1:1:150
    ...
    while 1
        ...
        Ploss_dcac_outSW = 3 * 2 * (IStop_three_avg * TempDriftvfIGBT(T_H2_arr(2,Count_T_H2)) * Vce_IGBT + ...
            Idtopbd_three_avg * TempDriftdiode(T_H2_arr(2,Count_T_H2)) * Vec_IGBT + ...
            fsw / 2 * TempDriftEonIGBT(T_H2_arr(2,Count_T_H2)) * Eon_IGBT + ...
            fsw/2 * TempDriftEoffIGBT(T_H2_arr(2,Count_T_H2)) * Eoff_IGBT);
        Ploss_dcac_inSW = 3 * 2 * (ISsec_three_avg * TempDriftvfIGBT(T_H2_arr(2,Count_T_H2)) * Vce_IGBT + ...
            Idsecbd_three_avg * TempDriftdiode(T_H2_arr(2,Count_T_H2)) * Vec_IGBT + ...
            fsw / 2 * TempDriftEonIGBT(T_H2_arr(2,Count_T_H2)) * Eon_IGBT + ...
            fsw/2 * TempDriftEoffIGBT(T_H2_arr(2,Count_T_H2)) * Eoff_IGBT);
        Ploss_dcac_clpD = 3 * 2 * Idclp_three_avg * TempDriftdiode(T_H2_arr(2,Count_T_H2)) * Vec_IGBT;
